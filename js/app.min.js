...
function load_rand_post(t) {
    var e = loadingShow(t.id, !1);
    $.ajax({
        url: theme.ajaxurl,
        type: "POST",
        dataType: "html",
        ...
        $(t.id + " .ajax-panel").html(a), loadingHid(e)
    }).fail(function() {
        loadingHid(e)
    })
}
...
function isPC() {
    for (var t = navigator.userAgent, e = ["Android", "iPhone", "webOS", "BlackBerry", "SymbianOS", "Windows Phone", "iPad", "iPod"], a = !0, i = 0; i < e.length; i++)
        if (t.indexOf(e[i]) > 0) {
            a = !1;
            break
        } return a
...
function showAlert(t) {
    ...
    switch (t.status) {
        case 0:
            title = localize.successAlert, e = "primary", a = "icon-loading icon-spin";
            break;
        case 1:
            title = localize.successAlert, e = "success", a = "icon-adopt";
            break;
        case 2:
            title = localize.infoAlert, e = "info", a = "icon-tishi";
            break;
        case 3:
            title = localize.warningAlert, e = "warning", a = "icon-warning";
            break;
        case 4:
            title = localize.errorAlert, e = "danger", a = "icon-close-circle"
    }
    var i = t.msg;
    $("#alert_placeholder")[0] || $("body").append('<div id="alert_placeholder" class="text-sm" style="position:fixed;bottom:10px;right:-10px;z-index:5000"></div>');
    var o = $('<div class="alert-body io-alert-' + e + '" style="display:none;"><div class="alert alert-' + e + ' text-lg d-flex align-items-center" style="min-width:200px;max-width:360px;float:right;margin-bottom:10px;"><i class="iconfont ' + a + ' icon-lg" style="margin-right:10px"></i><span class="text-md mr-2">' + i + "</span></div></div>");
    $(".io-alert-primary")[0] && $(".io-alert-primary").hide(300, function() {
        $(this).remove()
    }), $("#alert_placeholder").append(o), "primary" == e ? o.show(200) : o.show(200).delay(3500).hide(300, function() {
        $(this).remove()
    })
}

function toTarget(t, e, a) {
    var i = t.children(".anchor"),
        o = t.children(".hover").first(),
        s = t.closest(".tab-auto-scrollbar");
    o && 0 < o.length || (o = a ? t.find(".active").parent() : t.find(".active")), 0 < o.length ? e ? i.css({
        left: o.position().left + s.scrollLeft() + "px",
        width: o.outerWidth() + "px",
        opacity: "1"
    }) : i.css({
        left: o.position().left + s.scrollLeft() + o.outerWidth() / 4 + "px",
...
function ioPopupTips(t, e, a) {
    ...
    var o = 1 == t ? "tips-success" : "tips-error",
        s = '<section class="io-bomb ' + o + ' io-bomb-sm io-bomb-open"><div class="io-bomb-overlay"></div><div class="io-bomb-body text-center"><div class="io-bomb-content bg-white px-5"><i class="iconfont ' + i + ' icon-8x"></i><p class="text-md mt-3">' + e + "</p></div></div></section>",
        n = $(s);
    $("body").addClass("modal-open").append(n), hasScrollbar() && $("body").css("padding-right", getScrollbarWidth()), setTimeout(function() {
        $("body").removeClass("modal-open"), hasScrollbar() && $("body").css("padding-right", ""), $.isFunction(a) && a(!0), n.removeClass("io-bomb-open").addClass("io-bomb-close"), setTimeout(function() {
            n.removeClass("io-bomb-close"), setTimeout(function() {
                n.remove()
            }, 200)
        }, 400)
    }, 2e3)
...
function ioPopup(t, e, a, i) {
    var a = a ? 'style="' + a + '"' : "",
        o = "";
    "big" == t ? o = "io-bomb-lg" : "no-padding" == t ? o = "io-bomb-nopd" : "cover" == t ? o = "io-bomb-cover io-bomb-nopd" : "full" == t ? o = "io-bomb-xl" : "small" == t ? o = "io-bomb-sm" : "confirm" == t && (o = "io-bomb-md");
    var s = '\t<div class="io-bomb ' + o + ' io-bomb-open">\t\t<div class="io-bomb-overlay" ' + a + '></div>\t\t<div class="io-bomb-body text-center">\t\t\t<div class="io-bomb-content bg-white">\t\t\t\t' + e + '\t\t\t</div>\t\t\t<div class="btn-close-bomb mt-2">                <i class="iconfont icon-close-circle"></i>            </div>\t\t</div>\t</div>\t',
        n = $(s);
    $("body").addClass("modal-open").append(n), hasScrollbar() && $("body").css("padding-right", getScrollbarWidth());
    var r = function() {
        $("body").removeClass("modal-open"), hasScrollbar() && $("body").css("padding-right", ""), $(n).removeClass("io-bomb-open").addClass("io-bomb-close"), setTimeout(function() {
            $(n).removeClass("io-bomb-close"), setTimeout(function() {
                n.remove()
            }, 200)
        }, 600)
    };
    return $(n).on("click touchstart", ".btn-close-bomb i, .io-bomb-overlay", function(t) {
        t.preventDefault(), $.isFunction(i) && i(!0), r()
    }), n
}

function ioConfirm(t, e) {
    var a = '\t<div class="io-bomb io-bomb-confirm io-bomb-open">\t\t<div class="io-bomb-overlay"></div>\t\t<div class="io-bomb-body">\t\t\t<div class="io-bomb-content bg-white">\t\t\t\t' + t + '                <div class="text-center mt-3">                    <button class="btn btn-danger mx-2" onclick="_onclick(true);">' + localize.okBtn + '</button>                    <button class="btn btn-light mx-2" onclick="_onclick(false);">' + localize.cancelBtn + "</button>                </div>\t\t\t</div>\t\t</div>\t</div>\t",
        i = $(a);
    $("body").addClass("modal-open").append(i), hasScrollbar() && $("body").css("padding-right", getScrollbarWidth()), _onclick = function(t) {
        o(), $.isFunction(e) && e(t)
    };
    var o = function() {
        $("body").removeClass("modal-open"), hasScrollbar() && $("body").css("padding-right", ""), $(i).removeClass("io-bomb-open").addClass("io-bomb-close"), setTimeout(function() {
            $(i).removeClass("io-bomb-close"), setTimeout(function() {
                i.remove()
            }, 200)
        }, 600)
    };
...
! function(t) {
    ...
    function n() {
        ...
        if (e.attr("style", ""), e.hasClass("footer-stick")) {
            var a = jQuery(window).height(),
                i = e.outerHeight(!0),
                o = e.position().top + i;
            a > o - parseInt(e.css("marginTop"), 10) && e.css({
                marginTop: a - o
            })
        }
    }
    ...
    function r() {
        "1" == theme.minNav && !T && 767.98 < t(window).width() || !T && 767.98 < t(window).width() && t(window).width() < 1024 ? (t("#mini-button").prop("checked", !1), d(), T = !0, S && (t("body").addClass("mini-sidebar"), S = !1)) : "1" != theme.minNav && (T && t(window).width() >= 1024 || S && !T && t(window).width() >= 1024) ? (t("#mini-button").prop("checked", !0), d(), T = !1, S && (S = !1)) : t(window).width() < 767.98 && t("body").hasClass("mini-sidebar") && (t("body").removeClass("mini-sidebar"), S = !0, T = !1)
    }
    ...
    function c(e, a, i) {
        e.addClass("disabled"), t.ajax({
            ...
            i.trim() && (a.html(i), isPC() && t('.ajax-url [data-toggle="tooltip"]').tooltip({
                trigger: "hover"
            }), e.addClass("load")), e.removeClass("disabled")
        }).fail(function() {
    ...
    function u(t) {
        for (var e = h("myLinks"), a = 0; a < e.length; a++)
            if (e[a].url == t.url) return void showAlert(JSON.parse('{"status":4,"msg":"' + localize.urlExist + '"}'));
        e.unshift(t), m(t, !1, !1), p(e, "myLinks")
    }

    function m(e, a, i) {
        a ? t(".customize_nothing_click").remove() : t(".customize_nothing").remove();
        var o, s = e.url.match(/^(?:https?:\/\/)?((?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6})/);
        !s || s.length < 2 ? o = e.url : (o = s[0], "1" == theme.urlformat && (o = s[1]));
        ...
        a ? (i ? t(".my-click-list").prepend(n) : t(".my-click-list").append(n), n.children(".remove-site").on("click", b)) : (t("#add-site").before(n), n.children(".remove-site").on("click", v)), z && n.children(".remove-site").show(), isPC() && t('.new-site[data-toggle="tooltip"]').tooltip({
            trigger: "hover"
        })
    }
    ...
    function f(e) {
        ...
        if (a.length)
            for (var i = 0; i < a.length; i++) m(a[i], e, !1)
    }

    function v() {
        for (var e = t(this).data("id"), a = h("myLinks"), i = 0; i < a.length; i++)
            if (parseInt(a[i].id) === parseInt(e)) {
                console.log(a[i].id, e), a.splice(i, 1);
                break
            } p(a, "myLinks"), t(this).parent().remove()
    }

    function b() {
        for (var e = t(this).data("id"), a = h("livelists"), i = 0; i < a.length; i++)
            if (parseInt(a[i].id) === parseInt(e)) {
                console.log(a[i].id, e), a.splice(i, 1);
                break
            } p(a, "livelists"), t(this).parent().remove()
    }
    ...
    function g() {
        t(".customize-sites").hasClass("edit") ? (isPC() && t('.customize-sites .new-site[data-toggle="tooltip"]').tooltip("disable"), t(".customize-sites .site-list").sortable({
            ...
            update: function(e, a) {
                ...
                var i = t(this).data("term_id"),
                    o = t(this).sortable("serialize"),
                    s = {
    ...
    function y() {
        var e = t(".s-type-list.big label").data("page"),
            a = window.localStorage.getItem("searchlist_" + e),
    ...
    function w(e, a) {
        t.ajax({
            ...
            success: function(e) {
                ...
                if (i.children("ul").text(""), $ = e[1].length) {
                    for (var o = 0; o < $; o++) i.children("ul").append("<li>" + e[1][o] + "</li>"), i.find("li").eq(o).click(function() {
                        var e = t(this).html();
    ...
    function k(e, a) {
        t.ajax({
            ...
            success: function(e) {
                var i = a.children(".search-smart-tips");
                if (i.children("ul").text(""), $ = e.s.length) {
                    for (var o = 0; o < $; o++) i.children("ul").append("<li>" + e.s[o] + "</li>"), i.find("li").eq(o).click(function() {
                        var e = t(this).html();
                        a.find(".smart-tips.search-key").val(e), a.children(".super-search-fm").submit(), i.slideUp(200)
                    });
                    i.slideDown(200)
    ...
    t(document).ready(function() {
        if ("1" !== theme.minNav && r(), i(!1), y(), n(), isPC() ? t('[data-toggle="tooltip"]').tooltip({
                trigger: "hover"
            }) : t('.qr-img[data-toggle="tooltip"]').tooltip({
                trigger: "hover"
            }), s(), t(".sidebar-tools").theiaStickySidebar({
                additionalMarginTop: 90,
                additionalMarginBottom: 20
            }), "1" === theme.isCustomize && (f(!1), f(!0)), t(window).scrollTop() >= 50 && (t("#go-to-up").fadeIn(200), t(".big-header-banner").addClass("header-bg")), t("#loading")[0]) {
            var a = t("#loading");
        ...
        x(), "1" === theme.isHome && setTimeout(function() {
            t('a.smooth[href="' + window.location.hash + '"]')[0] ? t('a.smooth[href="' + window.location.hash + '"]').click() : "" != window.location.hash && t("html, body").animate({
                scrollTop: t(window.location.hash).offset().top - 90
            }, {
                duration: 500,
                easing: "swing"
            })
        }, 300), e(t(".sidebar-item.top-menu"))
    }), t(document).on("click", "a.smooth", function(e) {
        var a = t(this);
        if (e.preventDefault(), t("#sidebar").hasClass("show") && !a.hasClass("change-href") && t("#sidebar").modal("toggle"), "#" == a.attr("href").substr(0, 1) && t(a.attr("href"))[0] && t("html, body").animate({
                scrollTop: t(a.attr("href")).offset().top - 90
            }, {
                duration: 500,
                easing: "swing"
        ...
        e.preventDefault(), t("html, body").animate({
            scrollTop: t(t(this).attr("href")).offset().top - 90
        }, {
            duration: 500,
            easing: "swing"
        })
    }), t(".panel-body.single img:not(.unfancybox)").each(function(e) {
        var a = t(this);
        a.hasClass("wp-smiley") || this.parentNode.href || ("1" == theme.lazyload ? a.wrap("<a class='js' href='" + a.data("src") + "' data-fancybox='fancybox' data-caption='" + this.alt + "'></a>") : a.wrap("<a class='js' href='" + this.src + "' data-fancybox='fancybox' data-caption='" + this.alt + "'></a>"))
    });
    var _ = 0;
    t(window).resize(function() {
    ...
    }), t(document).on("click", "a[target!='_blank']", function() {
        var e = t(this);
        if (isPC() && "1" == theme.loading && e.attr("href") && 0 != e.attr("href").indexOf("#") && 0 != e.attr("href").indexOf("java") && !e.data("fancybox") && !e.data("commentid") && !e.hasClass("nofx")) {
            ...
            t("body").prepend(a), a.animate({
                opacity: "1"
            }, 200, "swing").delay(2e3).hide(300, function() {
                a.remove()
            })
        }
    }), t(document).on("click", ".btn-like", function() {
        var e = t(this);
        if ("post_like" == e.data("action"))
            if (e.hasClass("liked")) showAlert(JSON.parse('{"status":1,"msg":"' + localize.liked + '"}'));
            else {
                var a = e.children(".flex-column");
                e.addClass("liked"), t.ajax({
                    ...
                    success: function(e) {
                        var i = t('<i class="iconfont icon-heart" style="color: #f12345;transform: scale(1) translateY(0);position: absolute;transition: .6s;opacity: 1;"></i>');
                        a.prepend(i), showAlert(JSON.parse('{"status":1,"msg":"' + localize.like + '"}')), t(".like-count").html(e), i.addClass("home-like-hide")
                    },
                    error: function() {
            ...
            var i = 0,
                o = e.data("id");
            e.hasClass("liked") && (i = 1), e.addClass("disabled"), t.ajax({
                type: "POST",
                url: theme.ajaxurl,
                data: {
                    action: e.data("action"),
                ...
                success: function(a) {
                    if (e.removeClass("disabled"), 1 == a.status) return t(".star-count-" + o).html(a.count), 1 == i ? (e.removeClass("liked"), e.find(".star-ico").removeClass("icon-collection").addClass("icon-collection-line")) : (e.addClass("liked"), e.find(".star-ico").removeClass("icon-collection-line").addClass("icon-collection")), ioPopupTips(a.status, a.msg), !1;
                    ioPopupTips(a.status, a.msg)
                },
                error: function() {
                    e.removeClass("disabled"), ioPopupTips(4, localize.networkerror)
                }
            })
        }
        return !1
        ...
        var e = t(this);
        if (e.hasClass("liked")) showAlert(JSON.parse('{"status":3,"msg":"' + localize.liked + '"}'));
        else {
            var a = e.data("id");
            e.addClass("liked"), t.ajax({
                type: "POST",
        ...
        return !1
    }), t(".io-add-link-form").on("submit", function() {
        var e = t(this);
        return t.ajax({
            url: theme.ajaxurl,
            type: "POST",
            ...
            if (1 != t.status) return void showAlert(t);
    ...
    t(document).on("click", ".sidebar-menu-inner .sidebar-more,.sidebar-menu-inner a", function() {
        ...
        var o = a.offset().top - t(window).scrollTop() + e,
            s = t(window).height() - t(".sidebar-popup.second>div").height();
        s - o <= 0 && (o = s >= 0 ? s - 8 : 0), i.stop().animate({
            top: o
        }, 50), a.one("mouseleave", function() {
        ...
        var a = t(this),
            i = a.data("id"),
            o = t(a.attr("href")).children(".site-list");
        0 == o.children(".url-card").length && (a.addClass("disabled"), t.ajax({
            ...
            if (e.trim()) {
                var i = t(e);
                o.html(i), isPC() && i.find('[data-toggle="tooltip"]').tooltip({
                    trigger: "hover"
                })
            }
        ...
        e.preventDefault();
        var a = t(this),
            i = t(a.attr("href")).children(".ajax-list-body");
        a.addClass("disabled"), t.ajax({
            ...
            if (e.trim()) {
                var o = t(e);
                i.html(o), isPC() && o.find('[data-toggle="tooltip"]').tooltip({
                    trigger: "hover"
                }), a.addClass("load")
            }
            a.removeClass("disabled")
        ...
        e.preventDefault(), c(t(this), t(t(this).attr("href")).children(".ajax-list-body"), t(this).parents("li").data())
    }), t(".add-link-form").on("submit", function() {
        var e = t(".site-add-name").val(),
            a = t(".site-add-url").val();
        u({
            id: +new Date,
            name: e,
            url: a
    ...
    t(".customize-menu .btn-edit").click(function() {
        ...
        var e = t(this),
            a = this,
            i = e.find("input[name=url]").val(),
            o = e.find("input[name=url_name]").val(),
            s = e.find("input:radio:checked").val();
        if ("" == e.find("input[name=term_name]").val() && void 0 == s) return showAlert(JSON.parse('{"status":3,"msg":"' + localize.selectCategory + '"}')), !1;
        t.ajax({
            url: theme.ajaxurl,
            type: "POST",
            dataType: "json",
            ...
            t(".add-custom-site[data-term_id=" + s + "]").before(c), a.reset(), a.querySelector("input").focus(), e.find(".btn-close-fm").click(), showAlert(JSON.parse('{"status":1,"msg":"' + localize.addSuccess + '"}'))
        }).fail(function() {
            showAlert(JSON.parse('{"status":4,"msg":"' + localize.networkerror + '"}'))
        })
        ...
        var a = t(this),
            i = {
                id: a.data("id"),
                name: a.find("strong").html(),
                url: a.data("url")
            };
        if ("" !== i.url) {
            for (var o = h("livelists"), s = !0, n = 0; n < o.length; n++) o[n].name === i.name && (s = !1);
            if (s) {
                var r = theme.customizemax;
                o.length > r - 1 && (t(".my-click-list .site-" + o[r - 1].id).parent().remove(), o.splice(r - 1, 1)), m(i, !0, !0), o.unshift(i), p(o, "livelists")
            }
        }
        ...
        var e = t(this),
            a = encodeURIComponent(e.find(".search-key").val());
        if ("" == a) return !1;
        var i = e.attr("action");
    ...
    t(".smart-tips.search-key").off().on({
        ...
        blur: function() {
            j = "", t(".search-smart-tips").delay(150).slideUp(200)
        },
        focus: function() {
            var e = t(this);
            if (A = "" != e.attr("zhannei"), j = e.parents("#search"), "true" == e.attr("data-status") && e.val() && !A) switch (theme.hotWords) {
                case "baidu":
                    k(e.val(), j);
                    break;
                case "google":
        ...
        keyup: function(e) {
            var a = t(this);
            if (A = "" != a.attr("zhannei"), j = a.parents("#search"), "true" == a.attr("data-status") && a.val()) {
                if (38 == e.keyCode || 40 == e.keyCode || A) return;
        ...
        keydown: function(e) {
            var a = t(this);
            if ("" == a.attr("zhannei")) {
                if (j = a.parents("#search"), 40 === e.keyCode) {
                    O === $ - 1 ? O = 0 : O++, j.find(".search-smart-tips ul li").eq(O).addClass("current").siblings().removeClass("current");
                    var i = j.find(".search-smart-tips ul li").eq(O).html();
                    j.find(".smart-tips.search-key").val(i)
                }
                if (38 === e.keyCode) {
                    e.preventDefault && e.preventDefault(), e.returnValue && (e.returnValue = !1), 0 === O || -1 === O ? O = $ - 1 : O--, j.find(".search-smart-tips ul li").eq(O).addClass("current").siblings().removeClass("current");
                    var i = j.find(".search-smart-tips ul li").eq(O).html();
                    j.find(".smart-tips.search-key").val(i)
                }
            }
    ...
    }, function() {}), t("#add-new-sites-modal").on("show.bs.modal", function(e) {
    ...
    }), t(document).on("click", "a.sidebar-rand-post", function() {
        load_rand_post(t(this).data())
    }), loadFunc(function() {
